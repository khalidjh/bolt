...
export function EventLogsTab() {
  ...
  const exportAsPDF = async () => {
    try {
      // Load jsPDF on demand — it's a multi-hundred-KB dependency only needed for PDF export.
      ...
      doc.text('Etlaq - AI Development Platform', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by Etlaq', margin, doc.internal.pageSize.getHeight() - 10);
